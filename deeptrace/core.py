...
from deeptrace import benchmarker, cli_helper, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, hash_helper, logger, state_manager, translator, voice_extractor
from deeptrace.args import apply_args, collect_job_args, reduce_job_args, reduce_step_args
from deeptrace.download import conditional_download_hashes, conditional_download_sources
from deeptrace.exit_helper import hard_exit, signal_exit
from deeptrace.filesystem import get_file_extension, get_file_name, is_image, is_video, resolve_file_paths, resolve_file_pattern
from deeptrace.jobs import job_helper, job_manager, job_runner
from deeptrace.jobs.job_list import compose_job_list
from deeptrace.memory import limit_system_memory
from deeptrace.processors.core import get_processors_modules
from deeptrace.program import create_program
from deeptrace.program_helper import validate_args
from deeptrace.types import Args, ErrorCode
from deeptrace.workflows import image_to_image, image_to_video
...
def route(args : Args) -> None:
	...
	if state_manager.get_item('command') == 'run':
		import deeptrace.uis.core as ui
