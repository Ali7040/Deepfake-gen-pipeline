...
from deeptrace.processors.modules.frame_enhancer.types import FrameEnhancerModel
...
def render() -> None:
	...
	FRAME_ENHANCER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'deeptrace.processors.modules.frame_enhancer'),
	...
	FRAME_ENHANCER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'deeptrace.processors.modules.frame_enhancer'),
