...
from deeptrace.processors.modules.frame_colorizer.types import FrameColorizerModel
...
def render() -> None:
	...
	FRAME_COLORIZER_MODEL_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.model_dropdown', 'deeptrace.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_SIZE_DROPDOWN = gradio.Dropdown(
		label = translator.get('uis.size_dropdown', 'deeptrace.processors.modules.frame_colorizer'),
	...
	FRAME_COLORIZER_BLEND_SLIDER = gradio.Slider(
		label = translator.get('uis.blend_slider', 'deeptrace.processors.modules.frame_colorizer'),
