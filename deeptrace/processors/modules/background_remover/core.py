...
from deeptrace import config, content_analyser, inference_manager, logger, state_manager, translator, video_manager
from deeptrace.common_helper import is_macos
...
from deeptrace.normalizer import normalize_color
from deeptrace.processors.modules.background_remover import choices as background_remover_choices
from deeptrace.processors.modules.background_remover.types import BackgroundRemoverInputs
...
from deeptrace.types import ApplyStateItem, Args, DownloadScope, ExecutionProvider, InferencePool, Mask, ModelOptions, ModelSet, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		deeptrace.jobs.job_store.register_step_keys([ 'background_remover_model', 'background_remover_color' ])
