...
from deeptrace import state_manager, translator, voice_extractor
from deeptrace.filesystem import is_video
from deeptrace.types import VoiceExtractorModel
...
def render() -> None:
	...
	VOICE_EXTRACTOR_MODEL_DROPDOWN = gradio.Dropdown(
		...
		choices = deeptrace.choices.voice_extractor_models,
