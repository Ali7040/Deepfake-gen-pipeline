...
from deeptrace import config, content_analyser, face_classifier, face_detector, face_landmarker, face_masker, face_recognizer, logger, state_manager, translator, video_manager
from deeptrace.face_analyser import scale_face
from deeptrace.face_helper import warp_face_by_face_landmark_5
...
from deeptrace.filesystem import in_directory, is_image, is_video, same_file_extension
from deeptrace.processors.modules.face_debugger import choices as face_debugger_choices
from deeptrace.processors.modules.face_debugger.types import FaceDebuggerInputs
from deeptrace.processors.types import ProcessorOutputs
from deeptrace.program_helper import find_argument_group
from deeptrace.types import ApplyStateItem, Args, Face, InferencePool, ProcessMode, VisionFrame
...
def register_args(program : ArgumentParser) -> None:
	...
	if group_processors:
		...
		deeptrace.jobs.job_store.register_step_keys([ 'face_debugger_items' ])
