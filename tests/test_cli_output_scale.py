...
from deeptrace.jobs.job_manager import clear_jobs, init_jobs
from deeptrace.types import Resolution, Scale
from deeptrace.vision import detect_image_resolution, detect_video_resolution
